...
protobuf.overrideDerivation (oldAttr: {
      ...
      preConfigure = ''
        ...
        export CXXFLAGS="-I${androidndk}/libexec/${androidndk.name}/sources/cxx-stl/llvm-libc++/libcxx/include -I${androidndk}/libexec/${androidndk.name}/sources/android/support/include -I${androidndk}/libexec/${androidndk.name}/sources/cxx-stl/llvm-libc++abi/libcxxabi/include -std=c++11 -frtti"
        export LD=${ndkWrapper}/bin/$NDK_TARGET-ld
        export LDFLAGS="-L${androidndk}/libexec/${androidndk.name}/sources/cxx-stl/llvm-libc++/libs/armeabi -lc++_shared -lm"
